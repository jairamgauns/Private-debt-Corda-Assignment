...
// The oracle flow to sign
@InitiatedBy(SignByOracle::class)
class SignByOracleHandler(val session: FlowSession) : FlowLogic<Unit>() {
    companion object {
    ...
    @Suspendable
    override fun call() {
        logger.info("+++++++++++++SignByOracleHandler+++++++++++++++++++++++++++")
        println("+++++++++++++SignByOracleHandler+++++++++++++++++++++++++++")
